...
def teacher_classroom_check_students(request):
    if not request.user.is_authenticated:
        return redirect('login_page')
    if request.user.user_type != 'Teacher':
        return redirect('home_page')
    return render(request, 'teacher/classroom_students.html')

def teacher_classroom_view_student(request):
    if not request.user.is_authenticated:
        return redirect('login_page')
    if request.user.user_type != 'Teacher':
        return redirect('home_page')
    return render(request, 'teacher/classroom_view_student.html')


def teacher_classroom_activities(request):
    if not request.user.is_authenticated:
        return redirect('login_page')
    if request.user.user_type != 'Teacher':
        return redirect('home_page')
    return render(request, 'teacher/classroom_activities.html')
...
def teacher_view_activity(request):
    if not request.user.is_authenticated:
        return redirect('login_page')
    if request.user.user_type != 'Teacher':
        return redirect('home_page')
    return render(request, 'teacher/classroom_view_activities.html')


def teacher_view_student_activity(request):
    if not request.user.is_authenticated:
        return redirect('login_page')
    if request.user.user_type != 'Teacher':
        return redirect('home_page')
    return render(request, 'teacher/classroom_view_student_activities.html')


def teacher_messages_content(request):
    if not request.user.is_authenticated:
        return redirect('login_page')
    if request.user.user_type != 'Teacher':
        return redirect('home_page')
...
def student_classroom_view_activity(request):
    if not request.user.is_authenticated:
        return redirect('login_page')
    if request.user.user_type != 'Student':
        return redirect('home_page')
